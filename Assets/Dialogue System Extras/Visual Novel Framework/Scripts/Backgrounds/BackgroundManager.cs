...
namespace PixelCrushers.DialogueSystem.VisualNovelFramework
{
    ...
    public class BackgroundManager : MonoBehaviour
    {
        ...
        public static void UpdateBackgroundFromVariable()
        {
            ...
            var value = DialogueLua.GetVariable("Background").asInt;
        ...
        public static void SetBackgroundImage(string backgroundName)
        {
            ...
            DialogueManager.LoadAsset(backgroundName, typeof(UnityEngine.Object), OnPrefabLoaded);
        }
        private static void OnPrefabLoaded(UnityEngine.Object asset)
        {
            if (asset == null)
            {
#if USE_ADDRESSABLES
            ...
            {
                m_instance.StartCoroutine(m_instance.SetBackgroundPrefabCoroutine(asset));
            }
        }
        ...
        private IEnumerator SetBackgroundPrefabCoroutine(UnityEngine.Object prefab)
        {
            if (m_instance.transform.childCount > 0)
            {
            ...
            var animator = fade.GetComponent<Animator>();
